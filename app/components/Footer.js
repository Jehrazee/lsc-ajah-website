    ...
    <footer style={{backgroundColor: '#06132e', color: 'white', padding: '60px 24px 20px'}}>
      <div style={{maxWidth: '1100px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '40px', marginBottom: '40px'}}>
        <div>
          ...
          <p style={{color: '#cccccc', marginBottom: '8px', fontSize: '13px', fontFamily: 'Montserrat, sans-serif', fontWeight: '300'}}>📞 +234 000 000 0000</p>
          <p style={{color: '#cccccc', fontSize: '13px', fontFamily: 'Montserrat, sans-serif', fontWeight: '300'}}>✉️ info@livingseedajah.org</p>
        </div>
        <div>
          <h4 style={{color: 'white', fontSize: '11px', fontWeight: '500', marginBottom: '16px', fontFamily: 'Montserrat, sans-serif', letterSpacing: '3px', textTransform: 'uppercase'}}>Quick Links</h4>
          <ul style={{listStyle: 'none', padding: 0}}>
            {['About', 'Sermons', 'Events', 'Give', 'Contact'].map(link => (
              <li key={link} style={{marginBottom: '10px'}}>
                <a href={`/${link.toLowerCase()}`} style={{color: '#cccccc', textDecoration: 'none', fontSize: '13px', fontFamily: 'Montserrat, sans-serif', fontWeight: '300', letterSpacing: '0.5px'}}>{link}</a>
              </li>
            ))}
          </ul>
        </div>
        <div>
          <h4 style={{color: 'white', fontSize: '11px', fontWeight: '500', marginBottom: '16px', fontFamily: 'Montserrat, sans-serif', letterSpacing: '3px', textTransform: 'uppercase'}}>Service Times</h4>
        ...
        <div>
          <h4 style={{color: 'white', fontSize: '11px', fontWeight: '500', marginBottom: '16px', fontFamily: 'Montserrat, sans-serif', letterSpacing: '3px', textTransform: 'uppercase'}}>Follow Us</h4>
